...
#define FFMPEG_CONFIGURATION "--enable-libfdk_aac --enable-nonfree --enable-libmp3lame --extra-cflags=-I/local/include --extra-ldflags=-L/local/lib"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 7.1.0 (x86_64-posix-seh-rev1, Built by MinGW-W64 project)"
